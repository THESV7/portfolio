...
const About = () => {
  return (
    ...
    >
      ...
      <div className="flex w-full max-w-screen-xl mx-auto flex-col lg:flex-row items-center gap-20 my-20">
          ...
          <ul className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl font-Outfit">
            {infoList.map(({ icon, iconDark, title, description }, index) => (
              <li
                ...
                key={index}
              >
                <Image src={icon} alt={title} className="w-7 mt-3 block dark:hidden" />
